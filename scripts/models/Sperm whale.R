...
#running the models in for-loops (sperm whales)
...
#..............................................................................
#..............................................................................
setwd("~/Documents/Work/Massey/Projects/NCGIS/SDM3/R_project/SB_SDM") #change to your working directory
...
Test_results = readRDS("results/models/SW/Test_results.rds")
#Pred_results = readRDS("results/models/SW/Pred_results.rds")
Test_results_TSS = readRDS("results/models/SW/Test_results_TSS.rds")


calib1 = read.csv("results/models/SW/calib1.csv")
eval1 = read.csv("results/models/SW/eval1.csv")
calib2 = read.csv("results/models/SW/calib2.csv")
eval2 = read.csv("results/models/SW/eval2.csv")
calib3 = read.csv("results/models/SW/calib3.csv")
eval3 = read.csv("results/models/SW/eval3.csv")
calib4 = read.csv("results/models/SW/calib4.csv")
eval4 = read.csv("results/models/SW/eval4.csv")
calib5 = read.csv("results/models/SW/calib5.csv")
eval5 = read.csv("results/models/SW/eval5.csv")
calib6 = read.csv("results/models/SW/calib6.csv")
eval6 = read.csv("results/models/SW/eval6.csv")
calib7 = read.csv("results/models/SW/calib7.csv")
eval7 = read.csv("results/models/SW/eval7.csv")
calib8 = read.csv("results/models/SW/calib8.csv")
eval8 = read.csv("results/models/SW/eval8.csv")
calib9 = read.csv("results/models/SW/calib9.csv")
eval9 = read.csv("results/models/SW/eval9.csv")
calib10 = read.csv("results/models/SW/calib10.csv")
eval10 = read.csv("results/models/SW/eval10.csv")
calib11 = read.csv("results/models/SW/calib11.csv")
eval11 = read.csv("results/models/SW/eval11.csv")
calib12 = read.csv("results/models/SW/calib12.csv")
eval12 = read.csv("results/models/SW/eval12.csv")
calib13 = read.csv("results/models/SW/calib13.csv")
eval13 = read.csv("results/models/SW/eval13.csv")
calib14 = read.csv("results/models/SW/calib14.csv")
eval14 = read.csv("results/models/SW/eval14.csv")
calib15 = read.csv("results/models/SW/calib15.csv")
eval15 = read.csv("results/models/SW/eval15.csv")
calib16 = read.csv("results/models/SW/calib16.csv")
eval16 = read.csv("results/models/SW/eval16.csv")
calib17 = read.csv("results/models/SW/calib17.csv")
eval17 = read.csv("results/models/SW/eval17.csv")
calib18 = read.csv("results/models/SW/calib18.csv")
eval18 = read.csv("results/models/SW/eval18.csv")
calib19 = read.csv("results/models/SW/calib19.csv")
eval19 = read.csv("results/models/SW/eval19.csv")
calib20 = read.csv("results/models/SW/calib20.csv")
eval20 = read.csv("results/models/SW/eval20.csv")
...
#env.label <- list("env_data", "FP_had_26", "FP_had_45", "FP_had_85", "FP_IPSL_26", "FP_IPSL_45", "FP_IPSL_85", "FP_MIROC_26", "FP_MIROC_45", "FP_MIROC_85", "FP_MPI_26", "FP_MPI_45", "FP_MPI_85")
...
for (i in 1:ni){
  print((i/ni)*100)
  Pred_test  = sre(Response = calib[[i]]$PA, Explanatory = calib[[i]][,c("depth", "slope", "aspect", "distance_shore", "distance_200m", "distance_1000m", "chll", "sst")], NewData = eval[[i]][,c("depth", "slope", "aspect", "distance_shore", "distance_200m", "distance_1000m", "chll", "sst")], Quant = 0); Test_results['SRE', i] <- somers2(Pred_test, eval[[i]]$PA)['C']
  #get TSS
  ...
  Test_results_TSS['SRE', i] <- TSS_SRE_res[1,1]
    ...
    # prediction on the total dataset
      for (j in 1: nj){
      setwd("~/Documents/Work/Massey/Projects/NCGIS/SDM3/R_project/SB_SDM/results/models/SW")
...
for (i in 1:ni){
  ...
  glmModAIC = stepAIC(glmStart, glm.formula, data = calib[[i]], direction = "both", trace = F, k=2, control=glm.control(maxit = 100))
  # prediction on the evaluation data and evaluation using the # AUC approach
  Pred_test <- predict.glm(glmModAIC, eval[[i]], type = 'response'); Test_results['GLM', i] <- somers2(Pred_test, eval[[i]]$PA)['C']
  #get TSS
  ...
  Test_results_TSS['GLM', i] <- TSS_GLM_res[1,1]
    ...
    setwd("~/Documents/Work/Massey/Projects/NCGIS/SDM3/R_project/SB_SDM/results/models/SW")
    Pred_results <- readRDS(paste0(pred_results[[j]],".rds"))
    Pred_results[, 'GLM', i] <- predict(glmModAIC, env[[j]], type = 'response')
    saveRDS(Pred_results, file= paste0(pred_results[[j]],".rds"))
    rm(Pred_results)
    }
}
...
for (i in 1:ni){
  print((i/ni)*100)
  gamStart <- gam(PA ~ 1, data = calib[[i]], family = binomial)
  gamModAIC <- step.Gam(gamStart, biomod2:::.scope(calib[[i]][1:3,c("depth", "slope", "aspect", "distance_shore", "distance_200m", "distance_1000m", "chll", "sst")], 's', 4), trace = F, direction = 'both')

  # prediction on the evaluation data and evaluation using the # AUC approach
  Pred_test <- predict.Gam(gamModAIC, newdata = eval[[i]], type = "response"); Test_results['GAM', i] <- somers2(Pred_test, eval[[i]]$PA)['C']
  #get TSS
  ...
  Test_results_TSS['GAM', i] <- TSS_GAM_res[1,1]
    ...
    for (j in 1: nj){
      ...
      setwd("~/Documents/Work/Massey/Projects/NCGIS/SDM3/R_project/SB_SDM/results/models/SW")
      Pred_results <- readRDS(paste0(pred_results[[j]],".rds"))
      Pred_results[, 'GAM', i] <- predict.Gam(gamModAIC, env[[j]], type = 'response')
      saveRDS(Pred_results, file= paste0(pred_results[[j]],".rds"))
      rm(Pred_results)
    }
}
...
for (i in 1:ni){
  print((i/ni)*100)
  Mars_int2 <- earth(PA ~ 1 + depth + slope + aspect + aspect + distance_shore + distance_200m + distance_1000m + chll +sst, data = calib[[i]], degree = 2, glm = list(family = binomial))
  # prediction on the evaluation data and evaluation using the # AUC approach
  Pred_test <- predict(Mars_int2, eval[[i]], type = 'response'); Test_results['MARS', i] <- somers2(Pred_test, eval[[i]]$PA)['C']
  #get TSS
  ...
  for (j in 1: nj){
    ...
    setwd("~/Documents/Work/Massey/Projects/NCGIS/SDM3/R_project/SB_SDM/results/models/SW")
    Pred_results <- readRDS(paste0(pred_results[[j]],".rds"))
    Pred_results[, 'MARS', i] <- predict(Mars_int2, env[[j]], type = 'response')
    saveRDS(Pred_results, file= paste0(pred_results[[j]],".rds"))
    rm(Pred_results)
  }
}
